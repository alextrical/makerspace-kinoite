...
*		- Option bytes programming : BOR level.
*		- Display option bytes.
*   	-Perform operation specific to STM32WB :
*			-	FW delete
*			-   FW upgrade
* NB for WB: you should set nBOOT0 = 0x0 et nBOOT1 = 0x1 in order to connect on the Bootloader
*  \code{.cpp}
**/
...
int USB_Example_WB(void) {

    logMessage(Title, "\n+++ USB STM32 WB Bootloader Example +++\n\n");
